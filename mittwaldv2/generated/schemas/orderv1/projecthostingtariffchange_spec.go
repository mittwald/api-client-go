...
type ProjectHostingTariffChangeSpec struct {
	AlternativeMachineTypeSpec *MachineTypeSpec
	AlternativeHardwareSpec    *HardwareSpec
}

func (a *ProjectHostingTariffChangeSpec) MarshalJSON() ([]byte, error) {
...
func (a *ProjectHostingTariffChangeSpec) UnmarshalJSON(input []byte) error {
...
func (a *ProjectHostingTariffChangeSpec) Validate() error {
	if a.AlternativeMachineTypeSpec != nil {
