...
var _ = Describe("ServiceRequestRelocationPayload", func() {
	When("unmarshaling from JSON", func() {
		It("should unmarshal", func() {
			exampleJSON := []byte("{\"contact\":{\"email\":\"string\",\"firstname\":\"string\",\"lastname\":\"string\",\"phone\":\"string\"},\"domain\":{\"allDomains\":true,\"domains\":[{\"authCode\":\"string\",\"domainName\":\"string\"}]},\"email\":{\"emailInboxes\":[{\"email\":\"string\",\"password\":\"string\"}]},\"notes\":\"string\",\"preferredRelocationDate\":\"2006-01-02T15:04:05Z\",\"redirectusKey\":42,\"source\":{\"providerName\":\"string\",\"providerPassword\":\"string\",\"providerUrl\":\"string\",\"providerUsername\":\"string\",\"sourceAccount\":\"string\"},\"target\":{\"accountShortId\":\"string\",\"application\":\"string\",\"articleType\":\"string\",\"organisation\":\"string\",\"prices\":[{\"name\":null,\"price\":null}],\"product\":\"string\",\"withDataCompare\":true},\"userId\":\"7a9d8971-09b0-4c39-8c64-546b6e1875ce\"}")

			sut := conversationv2.ServiceRequestRelocationPayload{}
