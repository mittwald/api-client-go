...
type CronjobTimeZoneUpdated struct {
	Changes    CronjobTimeZoneUpdatedChanges    `json:"changes"`
	Name       CronjobTimeZoneUpdatedName       `json:"name"`
	Parameters CronjobTimeZoneUpdatedParameters `json:"parameters"`
}

func (o *CronjobTimeZoneUpdated) Validate() error {
