...
type CronjobDeleted struct {
	Changes    CronjobDeletedChanges    `json:"changes"`
	Name       CronjobDeletedName       `json:"name"`
	Parameters CronjobDeletedParameters `json:"parameters"`
}

func (o *CronjobDeleted) Validate() error {
