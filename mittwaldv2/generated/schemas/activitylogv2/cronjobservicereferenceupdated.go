...
type CronjobServiceReferenceUpdated struct {
	Changes    CronjobServiceReferenceUpdatedChanges    `json:"changes"`
	Name       CronjobServiceReferenceUpdatedName       `json:"name"`
	Parameters CronjobServiceReferenceUpdatedParameters `json:"parameters"`
}

func (o *CronjobServiceReferenceUpdated) Validate() error {
