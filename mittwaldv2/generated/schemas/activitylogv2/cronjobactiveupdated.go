...
type CronjobActiveUpdated struct {
	Changes    CronjobActiveUpdatedChanges    `json:"changes"`
	Name       CronjobActiveUpdatedName       `json:"name"`
	Parameters CronjobActiveUpdatedParameters `json:"parameters"`
}

func (o *CronjobActiveUpdated) Validate() error {
