...
type CronjobTargetUpdated struct {
	Changes    CronjobTargetUpdatedChanges    `json:"changes"`
	Name       CronjobTargetUpdatedName       `json:"name"`
	Parameters CronjobTargetUpdatedParameters `json:"parameters"`
}

func (o *CronjobTargetUpdated) Validate() error {
