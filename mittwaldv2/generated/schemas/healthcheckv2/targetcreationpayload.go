...
//            maxLength: 500
//            maxProperties: 10
//        description: "Request headers. It is not possible to overwrite the user agent."
...
type TargetCreationPayload struct {
	Body         *string                          `json:"body,omitempty"`
	Description  *string                          `json:"description,omitempty"`
	Headers      map[string]string                `json:"headers,omitempty"`
	HttpMethod   *TargetCreationPayloadHttpMethod `json:"httpMethod,omitempty"`
...
func (o *TargetCreationPayload) Validate() error {
	if err := func() error {
		if o.HttpMethod == nil {
			return nil
		}
		return o.HttpMethod.Validate()
	}(); err != nil {
