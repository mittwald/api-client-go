...
type ProjectHostingOrderPreviewSpec struct {
	AlternativeMachineTypeSpec *MachineTypeSpec
	AlternativeHardwareSpec    *HardwareSpec
}

func (a *ProjectHostingOrderPreviewSpec) MarshalJSON() ([]byte, error) {
...
func (a *ProjectHostingOrderPreviewSpec) UnmarshalJSON(input []byte) error {
...
func (a *ProjectHostingOrderPreviewSpec) Validate() error {
	if a.AlternativeMachineTypeSpec != nil {
