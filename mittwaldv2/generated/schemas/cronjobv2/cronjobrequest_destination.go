...
func (a *CronjobRequestDestination) MarshalJSON() ([]byte, error) {
...
func (a *CronjobRequestDestination) UnmarshalJSON(input []byte) error {
...
func (a *CronjobRequestDestination) Validate() error {
	if a.AlternativeCronjobUrl != nil {
