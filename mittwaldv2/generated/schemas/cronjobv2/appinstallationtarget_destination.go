...
type AppInstallationTargetDestination struct {
	AlternativeCronjobUrl     *CronjobUrl
	AlternativeCronjobCommand *CronjobCommand
}

func (a *AppInstallationTargetDestination) MarshalJSON() ([]byte, error) {
...
func (a *AppInstallationTargetDestination) UnmarshalJSON(input []byte) error {
...
func (a *AppInstallationTargetDestination) Validate() error {
	if a.AlternativeCronjobUrl != nil {
