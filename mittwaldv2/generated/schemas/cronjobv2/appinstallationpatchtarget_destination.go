...
type AppInstallationPatchTargetDestination struct {
	AlternativeCronjobUrl     *CronjobUrl
	AlternativeCronjobCommand *CronjobCommand
}

func (a *AppInstallationPatchTargetDestination) MarshalJSON() ([]byte, error) {
...
func (a *AppInstallationPatchTargetDestination) UnmarshalJSON(input []byte) error {
...
func (a *AppInstallationPatchTargetDestination) Validate() error {
	if a.AlternativeCronjobUrl != nil {
