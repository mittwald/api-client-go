...
// 'domain-migration-check-migration-is-possible' operation. See [1] for more
// information.
//
// Check if a Domain-Migration from a pAccount into a Project is possible.
//
// [1]:
// https://developer.mittwald.de/docs/v2/reference/domain/domain-migration-check-migration-is-possible
