...
// DeprecatedRecordCnameSetRequest models a request for the
// 'deprecated-dns-record-cname-set' operation. See [1] for more information.
//
...
//
// [1]:
// https://developer.mittwald.de/docs/v2/reference/domain/deprecated-dns-record-cname-set
...
func (r *DeprecatedRecordCnameSetRequest) BuildRequest() (*http.Request, error) {
...
func (r *DeprecatedRecordCnameSetRequest) body() (io.Reader, string, error) {
