...
// GetDetailOfContractByAIHostingRequest models a request for the
// 'contract-get-detail-of-contract-by-ai-hosting' operation. See [1] for more
// information.
//
...
func (r *GetDetailOfContractByAIHostingRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}
...
func (r *GetDetailOfContractByAIHostingRequest) query() url.Values {
	return nil
}
