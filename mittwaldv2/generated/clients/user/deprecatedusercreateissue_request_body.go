...
//
type DeprecatedUserCreateIssueRequestBody struct {
	Message string                                   `json:"message"`
	Origin  *string                                  `json:"origin,omitempty"`
	Subject *string                                  `json:"subject,omitempty"`
	Type    DeprecatedUserCreateIssueRequestBodyType `json:"type"`
	Vote    *float64                                 `json:"vote,omitempty"`
}

func (o *DeprecatedUserCreateIssueRequestBody) Validate() error {
