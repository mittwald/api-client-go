...
type RequestDeviatingContributorAvatarUploadResponseRules struct {
	Extensions     []string                                                            `json:"extensions"`
	FileTypes      []RequestDeviatingContributorAvatarUploadResponseRulesFileTypesItem `json:"fileTypes"`
	MaxSizeInBytes int64                                                               `json:"maxSizeInBytes"`
	MimeTypes      []string                                                            `json:"mimeTypes"`
	Properties     *RequestDeviatingContributorAvatarUploadResponseRulesProperties     `json:"properties,omitempty"`
}

func (o *RequestDeviatingContributorAvatarUploadResponseRules) Validate() error {
	if o.Extensions == nil {
