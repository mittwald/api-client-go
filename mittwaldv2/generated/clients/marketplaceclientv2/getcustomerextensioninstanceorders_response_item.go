...
type GetCustomerExtensionInstanceOrdersResponseItem struct {
	Context      *GetCustomerExtensionInstanceOrdersResponseItemContext `json:"context,omitempty"`
	ExtensionId  *string                                                `json:"extensionId,omitempty"`
	ReferencedId *string                                                `json:"referencedId,omitempty"`
}

func (o *GetCustomerExtensionInstanceOrdersResponseItem) Validate() error {
	if err := func() error {
		if o.Context == nil {
			return nil
		}
