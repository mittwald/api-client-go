...
// ListLeadsExperimentalRequest models a request for the
// 'leadfyndr-list-leads-experimental' operation. See [1] for more information.
//
// Get all leads. Use the unlocked routes for more lead details.
//
// [1]:
// https://developer.mittwald.de/docs/v2/reference/leadfyndr/leadfyndr-list-leads-experimental
type ListLeadsExperimentalRequest struct {
	CustomerID                 string
	...
	Skip                       *int64
	Page                       *int64
	Sort                       []ListLeadsExperimentalRequestQuerySortItem
	Order                      []ListLeadsExperimentalRequestQueryOrderItem
}

// BuildRequest builds an *http.Request instance from this request that may be used
// with any regular *http.Client instance.
func (r *ListLeadsExperimentalRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *ListLeadsExperimentalRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}

func (r *ListLeadsExperimentalRequest) url() string {
	u := url.URL{
		Path:     fmt.Sprintf("/v2-experimental/customers/%s/leads", url.PathEscape(r.CustomerID)),
		RawQuery: r.query().Encode(),
	}
	return u.String()
}

func (r *ListLeadsExperimentalRequest) query() url.Values {
	q := make(url.Values)
