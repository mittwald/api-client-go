...
// ListUnlockedLeadsExperimentalRequest models a request for the
// 'leadfyndr-list-unlocked-leads-experimental' operation. See [1] for more
// information.
//
// Get all unlocked leads. Organisation can unlock leads.
//
// [1]:
// https://developer.mittwald.de/docs/v2/reference/leadfyndr/leadfyndr-list-unlocked-leads-experimental
type ListUnlockedLeadsExperimentalRequest struct {
	CustomerID                 string
...
func (r *ListUnlockedLeadsExperimentalRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *ListUnlockedLeadsExperimentalRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}

func (r *ListUnlockedLeadsExperimentalRequest) url() string {
	u := url.URL{
		Path:     fmt.Sprintf("/v2-experimental/customers/%s/unlocked-leads", url.PathEscape(r.CustomerID)),
		RawQuery: r.query().Encode(),
	}
	return u.String()
}

func (r *ListUnlockedLeadsExperimentalRequest) query() url.Values {
	q := make(url.Values)
