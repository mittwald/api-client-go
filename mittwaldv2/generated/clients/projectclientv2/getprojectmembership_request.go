...
func (r *GetProjectMembershipRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *GetProjectMembershipRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}
