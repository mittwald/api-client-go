...
func (r *StoragespaceReplaceServerNotificationThresholdRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *StoragespaceReplaceServerNotificationThresholdRequest) body() (io.Reader, string, error) {
