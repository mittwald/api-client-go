...
type CreateCertificateRequestRequestBody struct {
	...
	AlternativeCertificateRequestCreateWithCSRRequest *sslv1.CertificateRequestCreateWithCSRRequest
}
...
func (a *CreateCertificateRequestRequestBody) UnmarshalJSON(input []byte) error {
	...
	reader.Reset(input)
	var alternativeCertificateRequestCreateRequest sslv1.CertificateRequestCreateRequest
	...
	reader.Reset(input)
	var alternativeCertificateRequestCreateWithCSRRequest sslv1.CertificateRequestCreateWithCSRRequest
