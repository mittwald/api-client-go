...
type TLSDeprecatedRequestBody struct {
	AlternativeTlsAcme        *ingressv1.TlsAcme
	AlternativeTlsCertificate *ingressv1.TlsCertificate
}

func (a *TLSDeprecatedRequestBody) MarshalJSON() ([]byte, error) {
...
func (a *TLSDeprecatedRequestBody) UnmarshalJSON(input []byte) error {
...
func (a *TLSDeprecatedRequestBody) Validate() error {
	if a.AlternativeTlsAcme != nil {
