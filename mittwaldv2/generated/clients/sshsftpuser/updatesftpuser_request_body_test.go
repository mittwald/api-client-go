...
var _ = Describe("UpdateSFTPUserRequestBody", func() {
	When("unmarshaling from JSON", func() {
		It("should unmarshal", func() {
			exampleJSON := []byte("{\"accessLevel\":\"read\",\"active\":true,\"description\":\"string\",\"directories\":[\"string\"],\"expiresAt\":\"string\",\"password\":\"string\",\"publicKeys\":[{\"comment\":\"string\",\"key\":\"string\"}]}")
