...
func (r *ScheduleStraceRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *ScheduleStraceRequest) body() (io.Reader, string, error) {
...
func (r *ScheduleStraceRequest) url() string {
	u := url.URL{
		Path: fmt.Sprintf("/v2/projects/%s/straces", url.PathEscape(r.ProjectID)),
	}
	return u.String()
}
