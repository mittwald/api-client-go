...
// DeprecatedServiceAvatarRequestUploadRequest models a request for the
// 'deprecated-user-service-avatar-request-upload' operation. See [1] for more
// information.
//
...
func (r *DeprecatedServiceAvatarRequestUploadRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *DeprecatedServiceAvatarRequestUploadRequest) body() (io.Reader, string, error) {
