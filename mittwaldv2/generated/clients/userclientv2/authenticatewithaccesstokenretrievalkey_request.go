...
func (r *AuthenticateWithAccessTokenRetrievalKeyRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *AuthenticateWithAccessTokenRetrievalKeyRequest) body() (io.Reader, string, error) {
