...
type CreateTariffChangeRequestBodyTariffChangeData struct {
	...
	AlternativeServerTariffChange         *orderv1.ServerTariffChange
}
...
func (a *CreateTariffChangeRequestBodyTariffChangeData) UnmarshalJSON(input []byte) error {
	...
	reader.Reset(input)
	var alternativeProjectHostingTariffChange orderv1.ProjectHostingTariffChange
	...
	reader.Reset(input)
	var alternativeServerTariffChange orderv1.ServerTariffChange
