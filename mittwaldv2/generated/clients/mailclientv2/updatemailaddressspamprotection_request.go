...
// UpdateMailAddressSpamProtectionRequest models a request for the
// 'mail-update-mail-address-spam-protection' operation. See [1] for more
// information.
//
// Update the spam protection of a MailAddress.
//
// [1]:
// https://developer.mittwald.de/docs/v2/reference/mail/mail-update-mail-address-spam-protection
...
func (r *UpdateMailAddressSpamProtectionRequest) BuildRequest() (*http.Request, error) {
...
func (r *UpdateMailAddressSpamProtectionRequest) body() (io.Reader, string, error) {
