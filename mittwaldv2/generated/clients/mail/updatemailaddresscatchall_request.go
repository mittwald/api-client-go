...
func (r *UpdateMailAddressCatchAllRequest) BuildRequest() (*http.Request, error) {
	body, err := r.body()
	if err != nil {
		return nil, err
	}
...
func (r *UpdateMailAddressCatchAllRequest) body() (io.Reader, error) {
...
func (r *UpdateMailAddressCatchAllRequest) url() string {
	return fmt.Sprintf("/v2/mail-addresses/%s/catch-all", url.PathEscape(r.MailAddressID.String()))
}
