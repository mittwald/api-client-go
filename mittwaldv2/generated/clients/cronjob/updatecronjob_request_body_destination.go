...
type UpdateCronjobRequestBodyDestination struct {
	AlternativeCronjobUrl     *cronjobv1.CronjobUrl
	AlternativeCronjobCommand *cronjobv1.CronjobCommand
}
...
func (a *UpdateCronjobRequestBodyDestination) UnmarshalJSON(input []byte) error {
	...
	reader.Reset(input)
	var alternativeCronjobUrl cronjobv1.CronjobUrl
	...
	reader.Reset(input)
	var alternativeCronjobCommand cronjobv1.CronjobCommand
