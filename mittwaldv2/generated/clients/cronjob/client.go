...
type Client interface {
	...
	) (*[]cronjobv1.Cronjob, *http.Response, error)
	CreateCronjob(
		ctx context.Context,
	...
	) (*[]cronjobv1.CronjobExecution, *http.Response, error)
	CreateExecution(
		ctx context.Context,
...
func (c *clientImpl) ListCronjobs(
	...
	var response []cronjobv1.Cronjob
...
func (c *clientImpl) ListExecutions(
	...
	var response []cronjobv1.CronjobExecution
	if err := json.NewDecoder(httpRes.Body).Decode(&response); err != nil {
		return nil, httpRes, err
	}
	return &response, httpRes, nil
