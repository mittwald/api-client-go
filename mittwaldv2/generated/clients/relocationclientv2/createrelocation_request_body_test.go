...
var _ = Describe("CreateRelocationRequestBody", func() {
	When("unmarshaling from JSON", func() {
		It("should unmarshal", func() {
			exampleJSON := []byte("{\"additionalServices\":{\"dataCompare\":\"default\"},\"allDomains\":true,\"allowPasswordChange\":true,\"articleType\":\"cms-hosting\",\"contact\":{\"email\":\"string\",\"firstName\":\"string\",\"lastName\":\"string\",\"phoneNumber\":\"string\"},\"domains\":[{\"authCode\":null,\"domainOwnerData\":null,\"name\":\"string\"}],\"emailInboxes\":[{\"email\":\"string\",\"password\":\"string\"}],\"notes\":\"string\",\"prices\":{\"positions\":[{\"name\":\"string\",\"price\":3.14}],\"total\":3.14},\"provider\":{\"loginUrl\":\"string\",\"name\":\"string\",\"password\":\"string\",\"sourceAccount\":\"string\",\"userName\":\"string\"},\"target\":{\"organisation\":\"string\",\"product\":\"string\",\"projectName\":\"string\",\"system\":\"kc\"},\"userId\":\"7a9d8971-09b0-4c39-8c64-546b6e1875ce\"}")
