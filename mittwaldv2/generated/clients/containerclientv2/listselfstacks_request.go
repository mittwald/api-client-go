...
// ListSelfStacksRequest models a request for the 'container-list-self-stacks'
...
func (r *ListSelfStacksRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}

func (r *ListSelfStacksRequest) url() string {
	u := url.URL{
		Path:     "/v2/stacks",
