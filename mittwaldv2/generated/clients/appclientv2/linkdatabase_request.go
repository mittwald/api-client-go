...
func (r *LinkDatabaseRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *LinkDatabaseRequest) url() string {
	u := url.URL{
		Path: fmt.Sprintf("/v2/app-installations/%s/database", url.PathEscape(r.AppInstallationID)),
	}
	return u.String()
}
