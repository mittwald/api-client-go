...
func (r *ListMysqlDatabasesRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *ListMysqlDatabasesRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}
