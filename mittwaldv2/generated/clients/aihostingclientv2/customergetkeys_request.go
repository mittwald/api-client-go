...
// CustomerGetKeysRequest models a request for the 'ai-hosting-customer-get-keys'
...
func (r *CustomerGetKeysRequest) BuildRequest(reqEditors ...func(req *http.Request) error) (*http.Request, error) {
...
func (r *CustomerGetKeysRequest) body() (io.Reader, string, error) {
	return nil, "", nil
}
