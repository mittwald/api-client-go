...
type Client interface {
	...
	) (*[]marketplacev1.ExtensionInstance, *http.Response, error)
	...
	) (*marketplacev1.Contributor, *http.Response, error)
	...
	) (*marketplacev1.Extension, *http.Response, error)
	GetPublicKey(
		ctx context.Context,
		req GetPublicKeyRequest,
	) (*marketplacev1.PublicKey, *http.Response, error)
	ListContributors(
		ctx context.Context,
...
func (c *clientImpl) ListExtensionInstances(
	...
	var response []marketplacev1.ExtensionInstance
	if err := json.NewDecoder(httpRes.Body).Decode(&response); err != nil {
		return nil, httpRes, err
	}
	return &response, httpRes, nil
...
func (c *clientImpl) GetContributor(
	...
	var response marketplacev1.Contributor
	if err := json.NewDecoder(httpRes.Body).Decode(&response); err != nil {
		return nil, httpRes, err
	}
	return &response, httpRes, nil
...
func (c *clientImpl) GetExtension(
	...
	var response marketplacev1.Extension
	if err := json.NewDecoder(httpRes.Body).Decode(&response); err != nil {
		return nil, httpRes, err
	}
	return &response, httpRes, nil
...
func (c *clientImpl) GetPublicKey(
	...
	var response marketplacev1.PublicKey
	if err := json.NewDecoder(httpRes.Body).Decode(&response); err != nil {
		return nil, httpRes, err
	}
	return &response, httpRes, nil
